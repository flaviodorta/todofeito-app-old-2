...
export const ContentContainer = ({
  ...
  const [todosListWidth, setTodosWidthList] = useState(640);
  ...
  return (
    <div className=' mx-auto w-full md:w-[672px] md:max-w-[672px] md:min-w-[672px] flex justify-center'>
      <div
        className={`${
      ...
      >
        <div className='fixed w-full flex justify-center items-end bg-white h-[70px] left-0 top-12 right-0 z-20'>
          <div style={{ width: todosListWidth }} className='py-2 z-20'>
            {children}
          </div>
        </div>

        <div ref={todosListRef} className='mt-12'>
